...
const Checkout = () => {
  ...
  const productType = product.productType || 'Men'; // Ensure productType is valid
  ...
  const handleBuyNow = () => {
    navigate('/buynow', {
      state: {
        product: {
          ...product,
          productType, // Ensure this is valid
        },
        quantity,
        total,
      },
    ...
    <Container className="d-flex h-75 justify-content-center shadow align-items-center vh-100" style={{ backgroundColor: "white" }}>
      <Row className="d-flex">
        ...
        <Col style={{ marginLeft: "-96px" }} className="shadw ps-5 mt-5 pt-1" lg={4}>
          ...
          <Button variant="primary" className="ms-2 my-3" onClick={handleBuyNow}>
            Buy Now
          </Button>
        </Col>
      </Row>
